...
<script>
    ...
    axios.get('{{ route('api.builds.index') }}')
    ...
    @can('create', new App\Models\Build)
    var theMarker;
    map.on('click', function(e) {
        ...
        popupContent += '<br><a href="{{ route('admin.builds.create') }}?lat=' + latitude + '&lng=' + longitude + '">Add new build here</a>';
