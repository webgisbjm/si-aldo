...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.spm.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.spms.update", [$spm->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('kelurahans') ? 'is-invalid' : '' }}" name="kelurahans_id" id="kelurahans_id" required>
                    @foreach($kelurahans as $id => $entry)
                        <option value="{{ $id }}" {{ (old('kelurahans_id') ? old('kelurahans_id') : $spm->kelurahans->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('year') ? 'is-invalid' : '' }}" name="year" id="year" required>
                    ...
                    @foreach(App\Models\Spm::YEAR_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('year', $spm->year) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
                @if($errors->has('year'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('qty_house') ? 'is-invalid' : '' }}" type="number" name="qty_house" id="qty_house" value="{{ old('qty_house', $spm->qty_house) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('basic_target') ? 'is-invalid' : '' }}" type="number" name="basic_target" id="basic_target" value="{{ old('basic_target', $spm->basic_target) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('spalds_target') ? 'is-invalid' : '' }}" type="number" name="spalds_target" id="spalds_target" value="{{ old('spalds_target', $spm->spalds_target) }}" step="1" >
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('spaldt_target') ? 'is-invalid' : '' }}" type="number" name="spaldt_target" id="spaldt_target" value="{{ old('spaldt_target', $spm->spaldt_target) }}" step="1" >
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('basic_realization') ? 'is-invalid' : '' }}" type="number" name="basic_realization" id="basic_realization" value="{{ old('basic_realization', $spm->basic_realization) }}" step="1" >
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('spalds_realization') ? 'is-invalid' : '' }}" type="number" name="spalds_realization" id="spalds_realization" value="{{ old('spalds_realization', $spm->spalds_realization) }}" step="1" >
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('spaldt_realization') ? 'is-invalid' : '' }}" type="number" name="spaldt_realization" id="spaldt_realization" value="{{ old('spaldt_realization', $spm->spaldt_realization) }}" step="1" >
