...
<script>
    ...
    axios.get('{{ route('api.nsups.index') }}')
    ...
    @can('create', new App\Models\Nsup)
    var theMarker;
    map.on('click', function(e) {
        ...
        popupContent += '<br><a href="{{ route('admin.nsups.create') }}?lat=' + latitude + '&lng=' + longitude + '">Add new build here</a>';
