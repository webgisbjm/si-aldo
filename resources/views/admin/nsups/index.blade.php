...
@can('nsup_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            ...
            <a class="btn btn-info mt-2" href="{{ route('admin.nsups.map') }}">
...
<div class="card">
    ...
    <div class="card-body">
        <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-Nsup">
            <thead>
                <tr>
                    <th width="10">
                ...
                <tr>
                    ...
                    <td>
                        <select class="search" strict="true">
                            <option value>{{ trans('global.all') }}</option>
                            @foreach(App\Models\Nsup::YEARS_SELECT as $key => $item)
...
@can('nsup_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('admin.nsups.massDestroy') }}",
...
{ data: 'actions', name: '{{ trans('global.actions') }}' }
  ...
  let table = $('.datatable-Nsup').DataTable(dtOverrideGlobals);
