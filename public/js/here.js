if (navigator.geolocation){
    navigator.geolocation.getCurrentPosition( position=> {
        ...
        //Browse Location Codespace show pin
        let spaces = [];
        ...
        //Menghapus Marker Lama Pada Pergeseran Peta
        function clearSpace() {
            map.removeObjects(spaces);
            spaces = [];
        }

        //Eksekusi Fungsi Sebelumnya
        ...
        //Jika Pin terpindah dapat titik koordinat baru
        ...
        function addRouteShapeToMap(route){
            ...
            // And zoom to its bounding rectangle, zoom in zoomout
