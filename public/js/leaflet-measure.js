! function (e) {
    ...
    e.exports = '<a class="{{ model.className }}-toggle js-toggle" href=# title="Ukur Jarak dan Luas">Measure</a> <div class="{{ model.className }}-interaction js-interaction"> <div class="js-startprompt startprompt"> <p>Ukur Jarak dan Luas</p> <ul class=tasks> <a href=# class="js-start start">Buat Pengukuran Baru</a> </ul> </div> <div class=js-measuringprompt> <p>Ukur Jarak dan Luas</p> <p class=js-starthelp>Mulai pengukuran dengan tambahkan titik di peta</p> <div class="js-results results"></div> <ul class="js-measuretasks tasks"> <li><a href=# class="js-cancel cancel">Batal</a></li> <li><a href=# class="js-finish finish">Akhiri Pengukuran</a></li> </ul> </div> </div> '
}, function (e, t, r) {
    e.exports = '<div class=group> <p class="lastpoint heading">Koordinat Titik Terakhir</p> <p>{{ model.lastCoord.dms.y }} <span class=coorddivider>/</span> {{ model.lastCoord.dms.x }}</p> <p>{{ numberFormat(model.lastCoord.dd.y, 6) }} <span class=coorddivider>/</span> {{ numberFormat(model.lastCoord.dd.x, 6) }}</p> </div> <% if (model.pointCount > 1) { %> <div class=group> <p><span class=heading>Keliling/ Panjang garis</span> {{ model.lengthDisplay }}</p> </div> <% } %> <% if (model.pointCount > 2) { %> <div class=group> <p><span class=heading>Luas</span> {{ model.areaDisplay }}</p> </div> <% } %> '
}, function (e, t, r) {
    e.exports = '<h6>Koordinat Titik</h6> <p>{{ model.lastCoord.dms.y }} <span class=coorddivider>/</span> {{ model.lastCoord.dms.x }}</p> <p>{{ numberFormat(model.lastCoord.dd.y, 6) }} <span class=coorddivider>/</span> {{ numberFormat(model.lastCoord.dd.x, 6) }}</p> <ul class=tasks> <li><a href=# class="js-zoomto zoomto">Ke Titik Tengah Lokasi</a></li> <li><a href=# class="js-deletemarkup deletemarkup">Delete</a></li> </ul> '
}, function (e, t, r) {
    e.exports = '<h6>Panjang Garis</h6> <p>{{ model.lengthDisplay }}</p> <ul class=tasks> <li><a href=# class="js-zoomto zoomto">Ke Titik Tengah line</a></li> <li><a href=# class="js-deletemarkup deletemarkup">Delete</a></li> </ul> '
}, function (e, t, r) {
    e.exports = '<h6>Luas</h6> <p>{{ model.areaDisplay }}</p> <p>{{ model.lengthDisplay }} Keliling</p> <ul class=tasks> <li><a href=# class="js-zoomto zoomto">Ke Titik Tengah area</a></li> <li><a href=# class="js-deletemarkup deletemarkup">Delete</a></li> </ul> '
}]);
